  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
        <title>New Dynamic Petro Energy
		</title>
	    <!-- Bootstrap CSS -->
    ...
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item dropdown">
        <a class="nav-link" href="#" data-toggle="dropdown">Services <i class="fas fa-chevron-down"></i></a>
		  <ul class="dropdown-menu small-menu">
		     <a href="urban-infrastructure.php">Water Jetting</a>
		     <a href="road-infrastructure.php">Heat Exchanger Services</a>
		     <a href="industrial-infrastructure.php">Welding and Fabrication</a>
		     <a href="construction-engineering.php">Design Drawing</a>
		     <a href="structure-engineering.php">Pipeline and Processing</a>
		     <a href="water-sewage-engineering.php">Equipment Rentals</a>
